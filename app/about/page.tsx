...
export const metadata: Metadata = {
  ...
  description:
    "Our mission, vision, and what makes Afrix Global different. We don't only train talent. We deploy talent.",
};
...
const timeline = [
  {
    year: "2021",
    title: "The Beginning",
    desc: "Afrix Global launches its first digital talent bootcamp.",
  },
  {
    year: "2022",
    title: "Talent 4 Startups",
    desc: "We begin connecting graduates to international startup projects.",
  },
  {
    year: "2023",
    title: "Innovation Hub",
    desc: "Our physical and digital innovation ecosystem opens its doors.",
  },
  {
    year: "2024",
    title: "Going Global",
    desc: "Talent deployed across 12 countries on real-world projects.",
  },
];
      ...
      <Section>
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <MediaZone
            ...
            alt="Afrix Global leadership team"
            aspect="aspect-[4/3]"
          />
        </div>
      </Section>
      ...
      <Section className="bg-card/40">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <MediaZone
            ...
            alt="Afrix Global community event"
            aspect="aspect-[4/3]"
          ...
          <div className="lg:order-1">
            ...
            <p className="mt-6 text-2xl font-bold leading-tight tracking-tight text-foreground text-balance sm:text-3xl">
              To become Africa&apos;s leading ecosystem for digital talent,

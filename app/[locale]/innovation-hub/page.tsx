...
export const metadata: Metadata = {
  ...
  description:
    "A physical and digital ecosystem for innovation and startups. Turn ideas into scalable African startups.",
};
...
const activities = [
  {
    ...
    desc: "From idea to launch with structured incubation and resources.",
  },
  {
    icon: Code,
    title: "Hackathons",
    desc: "High-energy events where ideas become working prototypes.",
  },
  {
    icon: Users,
    title: "Mentorship",
    desc: "Guidance from founders, operators, and industry experts.",
  },
  {
    icon: Network,
    title: "Investor Networking",
    desc: "Connect with investors ready to back African innovation.",
  },
  {
    icon: Building,
    title: "Coworking Space",
    desc: "A premium space designed for builders and collaboration.",
  },
  {
    icon: Target,
    title: "Founder Support",
    desc: "Operational and strategic support at every stage of growth.",
  },
];
    ...
    <>
      ...
      <Section>
        <MediaZone
          ...
          alt="Afrix Global Innovation Hub coworking space"
          aspect="aspect-[16/9]"
        />
      </Section>
      ...
      <Section className="bg-card/40">
        <SectionHeading
          ...
          title="Everything founders need to build"
        />
      ...
      <Section>
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <MediaZone
            src="/images/hubcross.jpg"
            alt="Hackathon event at the Innovation Hub"
            aspect="aspect-[4/3]"
          />
          <div>
            <SectionHeading

...
export default function PartnersSection() {
  return (
    <section
      className="w-full h-auto py-12 md:py-20 bg-afrix-dark flex flex-col items-center gap-10 overflow-hidden"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="relative mx-auto md:my-12 w-full overflow-hidden">
        {/* Fade gauche */}

...
export function BlogGrid() {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "radial-gradient(circle at 0% 0%, rgba(66, 133, 244, 0.3), transparent 17%), radial-gradient(circle at 100% 0%, rgba(219, 68, 55, 0.3), transparent 15%)",
      }}
    >
          ...
          <div className="flex flex-col lg:flex-row">
            <div className="relative w-full lg:w-1/2 h-[250px] lg:h-auto min-h-[300px] overflow-hidden">
              ...
              <div className="absolute top-4 left-4">
                <Badge
                  className={`${articles[0].categoryColor} text-white border-0`}
                >
                  {articles[0].category}
                </Badge>
              </div>
          ...
          >
            <div className="relative w-full h-[180px] overflow-hidden">
              ...
              <div className="absolute top-3 left-3">
                <Badge
                  className={`${article.categoryColor} text-white border-0 text-xs`}
                >
                  {article.category}
                </Badge>
              </div>
